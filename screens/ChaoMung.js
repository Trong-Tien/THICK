    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.middle2}>
                ...
                >
                    <Text style={styles.textButtonSignUp}>Tạo tài khoản</Text>
                </Pressable>
            </View>
            <View style={styles.bottom}>
                <Text style={styles.textAccount}>Đã Có Tài Khoản?</Text>
                <Pressable onPress={() => navigation.navigate('DangNhap')}>
                    {({ pressed }) => (pressed ? <Text style={styles.textButtonSignInClick}>Đăng Nhập</Text>
